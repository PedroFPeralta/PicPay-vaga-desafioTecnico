...
import com.tecnicalTest.PicPay.dtos.NotificationDTO;
...
public class NotificationService {
    ...
    public void sendNotification(User sender, String message) throws Exception {
        ...
        if (responseEntity.getStatusCode() != HttpStatus.OK){
            throw new Exception("Error with notification");
        }
    }
}
